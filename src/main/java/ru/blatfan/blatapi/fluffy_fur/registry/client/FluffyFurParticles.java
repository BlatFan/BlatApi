...
import ru.blatfan.blatapi.fluffy_fur.client.particle.*;
import ru.blatfan.blatapi.fluffy_fur.client.particle.behavior.ICustomBehaviorParticleRender;
import ru.blatfan.blatapi.fluffy_fur.client.particle.type.*;
...
public class FluffyFurParticles {
    ...
    public static RegistryObject<GenericParticleType> EMERALD = PARTICLES.register("emerald", GenericParticleType::new);
    ...
    public static RegistryObject<GenericParticleType> FIRE = PARTICLES.register("fire", GenericParticleType::new);
    ...
    public static class ClientRegistryEvents {
        ...
        public static void registerParticles(RegisterParticleProvidersEvent event) {
            ...
            particleEngine.register(EMERALD.get(), GenericParticleType.Factory::new);
            ...
            particleEngine.register(FIRE.get(), GenericParticleType.Factory::new);
