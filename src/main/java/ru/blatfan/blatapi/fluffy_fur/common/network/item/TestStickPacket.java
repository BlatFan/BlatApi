package ru.blatfan.blatapi.fluffy_fur.common.network.item;

import ru.blatfan.blatapi.fluffy_fur.FluffyFur;
import ru.blatfan.blatapi.fluffy_fur.client.particle.ParticleBuilder;
import ru.blatfan.blatapi.fluffy_fur.client.particle.behavior.*;
...
import ru.blatfan.blatapi.fluffy_fur.common.network.TwoPositionClientPacket;
...
public class TestStickPacket extends TwoPositionClientPacket {
    ...
    public void execute(Supplier<NetworkEvent.Context> context) {
        ...
        if (mode == 8) {
            ...
            ItemParticleOptions options = new ItemParticleOptions(FluffyFurParticles.ITEM.get(), new ItemStack(FluffyFurItems.TEST_STICK.get()));
