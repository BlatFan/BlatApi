...
public class BrokenBlockSkinEffect extends PlayerSkinEffect{
    public BrokenBlockSkinEffect(String id) {
        super(id);
    }
    ...
    public void tick(Player player) {
        if (random.nextFloat() < 0.2f) {
            ParticleBuilder.create(FluffyFurParticles.WISP)
                .setColorData(ColorParticleData.create(new Color(14, 7, 27)).build())
