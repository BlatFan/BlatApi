...
public class CatEarsModel extends EarsModel  {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_ear = model.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-1.5f, -3f, -1f, 3f, 4f, 2f, new CubeDeformation(0)), PartPose.offsetAndRotation(-2.5f, -8f, 0, 0, (float) (Math.PI * 2f), 0));
        PartDefinition right_ear_layer = right_ear.addOrReplaceChild("right_ear_layer", CubeListBuilder.create().texOffs(0, 7)
                .addBox(-1.5f, -3f, -1f, 3f, 4f, 2f, new CubeDeformation(0.25f)), PartPose.ZERO);
