...
public class CatTailModel extends TailModel  {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tail = model.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-2f, 0, -2f, 4f, 9f, 4f, new CubeDeformation(0)), PartPose.offsetAndRotation(0f, 11f, 0.5f, 0, 0, 0));
        PartDefinition tail_layer = tail.addOrReplaceChild("tail_layer", CubeListBuilder.create().texOffs(16, 0)
                .addBox(-2f, 0, -2f, 4f, 9f, 4f, new CubeDeformation(0.25f)), PartPose.ZERO);
