package ru.blatfan.blatapi.render.type;
...
public class FakeBlockRenderTypes extends RenderType {
  ...
  public static final RenderType LASER_MAIN_BEAM = create(BlatApi.MODID + ":mininglasermainbeam",
   ...
   * 
   */
  public static final RenderType FAKE_BLOCK = create(BlatApi.MODID + ":fakeblock",
   ...
   */
  public static final RenderType TRANSPARENT_COLOUR = create(BlatApi.MODID + ":transparentcolour",
   ...
   * 
   */
  public static final RenderType SOLID_COLOUR = create(BlatApi.MODID + ":solidcolour",
      DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS, BUFFERSIZE, CRUMBLING, SORT,
      RenderType.CompositeState.builder()
          .setShaderState(RENDERTYPE_LINES_SHADER)
          .setLayeringState(VIEW_OFFSET_Z_LAYERING)
   ...
   */
  public static final RenderType TOMB_LINES = create(BlatApi.MODID + ":tomb_lines",
