package ru.blatfan.blatapi.common.creativetab;
...
public class MultiCreativeTabBuilder extends CreativeModeTab.Builder {
    ...
    public static ResourceLocation STANDARD_SUB_ARROWS = BlatApi.guiLoc("sub_arrows");
    ...
    public MultiCreativeTabBuilder backgroundSuffix(String backgroundSuffix) {
        return withBackgroundLocation(ResourceLocation.parse("textures/gui/container/creative_inventory/tab_" + backgroundSuffix));
    }
    ...
    public MultiCreativeTab multiBuild() {
        if ((this.type == CreativeModeTab.Type.HOTBAR || this.type == CreativeModeTab.Type.INVENTORY) && this.displayItemsGenerator != EMPTY_GENERATOR) {
            ...
            creativeTab.multiBackgroundLocation = this.multiBackgroundLocation != null ? this.multiBackgroundLocation : ResourceLocation.parse("textures/gui/container/creative_inventory/tab_" + this.backgroundSuffix);
