...
import ru.blatfan.blatapi.common.network.playerskin.*;
...
public class BlatApiPacketHandler extends PacketHandler {
    public static final String PROTOCOL = "10";
    public static final SimpleChannel HANDLER = NetworkRegistry.newSimpleChannel(ResourceLocation.fromNamespaceAndPath(BlatApi.MOD_ID,"network"), () -> PROTOCOL, PROTOCOL::equals, PROTOCOL::equals);
