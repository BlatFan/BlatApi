package ru.blatfan.blatapi.client.effect;
...
import ru.blatfan.blatapi.client.particle.behavior.SphereParticleBehavior;
import ru.blatfan.blatapi.client.particle.behavior.TrailParticleBehavior;
...
import ru.blatfan.blatapi.client.screenshake.PositionedScreenshakeInstance;
...
public class BAEffects {
    ...
    public static void lightningBoltRender(LightningBolt entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        RenderBuilder builder = RenderBuilder.create().setRenderType(BARenderTypes.ADDITIVE);
    ...
    public static void explosionEffect(Level level, Vec3 pos) {
        ...
        ParticleBuilder.create(BARegistry.Particles.WISP)
                ...
                .randomVelocity(0.2f)
                .repeat(level, pos, 25);
        ParticleBuilder.create(BARegistry.Particles.SMOKE)
        ...
        ParticleBuilder.create(BARegistry.Particles.WISP)
                ...
                .setFriction(0.9f)
                .repeat(level, pos, 5);
        ParticleBuilder.create(BARegistry.Particles.CIRCLE)
