...
import ru.blatfan.blatapi.client.particle.behavior.ParticleBehavior;
import ru.blatfan.blatapi.client.particle.behavior.component.ParticleBehaviorComponent;
import ru.blatfan.blatapi.client.particle.data.*;
import ru.blatfan.blatapi.client.particle.options.GenericParticleOptions;
...
public class GenericParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTicks) {
        ...
        if (behavior == null) {
            super.render(renderType != null ? BARenderTypes.getDelayedRender().getBuffer(renderType) : vertexConsumer, camera, partialTicks);
        } else {
            behavior.render(this, renderType != null ? BARenderTypes.getDelayedRender().getBuffer(renderType) : vertexConsumer, camera, partialTicks);
        }
    }
