...
import ru.blatfan.blatapi.client.playerskin.PlayerSkinEffect;
...
import ru.blatfan.blatapi.common.network.playerskin.PlayerSkinChangePacket;
...
public class PlayerSkinMenuScreen extends Screen {
    ...
    public void initSkins() {
        skins.add(new SkinEntry(null, Text.create("gui.blatapi.skin_menu.standard")));
        PlayerSkinHandler.skins.forEach((id, skin) -> skins.add(new SkinEntry(skin, Component.literal(id))));
        
        skinCapes.add(new SkinCapeEntry(null, Text.create("gui.blatapi.skin_menu.standard")));
        PlayerSkinHandler.skinCapes.forEach((id, skin) -> skinCapes.add(new SkinCapeEntry(skin, Component.literal(id))));
        
        skinEffects.add(new SkinEffectEntry(null, Text.create("gui.blatapi.skin_menu.empty")));
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTicks) {
        ...
        Component component = Text.create("gui.blatapi.skin_menu.skins");
        BAMenuScreen.drawBlackBackground(gui, x, y + offset, font.width(component) + 8, mouseX, mouseY, partialTicks);
        ...
        for (SkinEntry skin : skins) {
            ...
            BAMenuScreen.drawBlackBackground(gui, x - (rowOffset / 2) + (size / 2), y + offset - (selected ? 1 : 0), size, selected ? 0.75f: 0.5f, mouseX, mouseY, partialTicks);
        ...
        component = Text.create("gui.blatapi.skin_menu.capes");
        BAMenuScreen.drawBlackBackground(gui, x, y + offset, font.width(component) + 8, mouseX, mouseY, partialTicks);
        gui.drawCenteredString(font, component, x, y + offset + 1, 16777215);
        ...
        component = Text.create("gui.blatapi.skin_menu.skin_effects");
        BAMenuScreen.drawBlackBackground(gui, x, y + offset, font.width(component) + 8, mouseX, mouseY, partialTicks);
        gui.drawCenteredString(font, component, x, y + offset + 1, 16777215);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        for (SkinEntry skin : skins) {
            ...
            if (selected) {
                ...
                BlatApiPacketHandler.sendToServer(new PlayerSkinChangePacket(minecraft.player.position().add(0, minecraft.player.getBbHeight(), 0)));
                this.onClose();
                return true;
            }
