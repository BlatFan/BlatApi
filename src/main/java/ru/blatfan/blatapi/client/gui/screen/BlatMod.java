...
public class BlatMod {
    ...
    public BlatMod(String id, String name, String version) {
        this.id = id;
        this.name = name;
        this.version = version;
    }
    
    public BlatMod setEdition(int edition) {
        this.edition = edition;
        return this;
    }
    
    public BlatMod setDev(String dev) {
        this.dev = dev;
        return this;
    }
    
    public BlatMod setItem(ItemStack itemStack) {
        this.itemStack = itemStack;
        return this;
    }
    
    public BlatMod setNameColor(Color nameColor) {
        this.nameColor = nameColor;
        return this;
    }
    
    public BlatMod setVersionColor(Color versionColor) {
        this.versionColor = versionColor;
        return this;
    }
    
    public BlatMod setDescription(Component description) {
    ...
    public BlatMod addLink(Component component, String string) {
        links.add(new Link(component, string));
        return this;
    }
    
    public BlatMod addIconLink(String string, String name, Color color, String icon, ResourceLocation font) {
    ...
    public BlatMod addIconLink(String string, String name, Color color, String icon) {
        return addIconLink(string, name, color, icon, BARegistry.Fonts.ICONS_LOCATION);
    }
    
    public BlatMod addBFLinks(String mod){
        return addBFLinks(mod.replace(" ", ""), mod.replace(' ', '-').toLowerCase(), mod.replace(' ', '-').toLowerCase());
    }
    public BlatMod addBFLinks(String git, String curse, String modr) {
    ...
    public BlatMod addTelegramLink(String string) {
        return addIconLink(string, "Telegram", telegramColor, "\u0011");
    }
    
    public BlatMod addGithubLink(String string) {
        return addIconLink(string, "GitHub", githubColor, "\u0002");
    }
    
    public BlatMod addCurseForgeLink(String string) {
        return addIconLink(string, "CurseForge", curseForgeColor, "\u0003");
    }
    
    public BlatMod addModrinthLink(String string) {
        return addIconLink(string, "Modrinth", modrinthColor, "\u0004");
    }
    
    public BlatMod addDiscordLink(String string) {
        return addIconLink(string, "Discord", discordColor, "\u0005");
    }
    
    public BlatMod addYouTubeLink(String string) {
        return addIconLink(string, "YouTube", youTubeColor, "\u0006");
    }
    
    public BlatMod addBlueSkyLink(String string) {
        return addIconLink(string, "BlueSky", blueSkyColor, "\u0007");
    }
    
    public BlatMod addRedditLink(String string) {
        return addIconLink(string, "Reddit", redditColor, "\u0008");
    }
    
    public BlatMod addWebsiteLink(String string, String website, Color color) {
        return addIconLink(string, website, color, "\u0009");
    }
    
    public BlatMod addWebsiteLink(String string, String website) {
        return addWebsiteLink(string, website, websiteColor);
    }
    
    public BlatMod addWebsiteLink(String string) {
        return addWebsiteLink(string, "Website", websiteColor);
    }
    
    public BlatMod addTwitterLink(String string) {
