...
import ru.blatfan.blatapi.common.network.playerskin.PlayerSkinSetPacket;
...
public class PlayerSkinHandler {
    ...
    public static void setSkinPacket(PlayerSkin skin) {
        BlatApiPacketHandler.sendToServer(new PlayerSkinSetPacket(skin.getId()));
    }

    public static void setSkinPacket(String skin) {
        BlatApiPacketHandler.sendToServer(new PlayerSkinSetPacket(skin));
    }
    ...
    public static void setSkinEffectPacket(PlayerSkinEffect effect) {
        BlatApiPacketHandler.sendToServer(new PlayerSkinSetEffectPacket(effect.getId()));
    }

    public static void setSkinEffectPacket(String effect) {
        BlatApiPacketHandler.sendToServer(new PlayerSkinSetEffectPacket(effect));
    }
    ...
    public static void setSkinCapePacket(PlayerSkinCape cape) {
        BlatApiPacketHandler.sendToServer(new PlayerSkinSetCapePacket(cape.getId()));
    }

    public static void setSkinCapePacket(String cape) {
        BlatApiPacketHandler.sendToServer(new PlayerSkinSetCapePacket(cape));
    }
