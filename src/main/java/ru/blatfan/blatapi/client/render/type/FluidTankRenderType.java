...
public class FluidTankRenderType extends RenderType {
  ...
  public static final RenderType RESIZABLE = create(BlatApi.MOD_ID + ":resizable_cuboid", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, true, false,
