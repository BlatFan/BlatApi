package ru.blatfan.blatapi.client.render.item;
...
public class LargeItemRenderer {
    ...
    public static ModelResourceLocation getModelResourceLocation(String modId, String item) {
        return new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(modId, item + "_in_hand"), "inventory");
    }
    ...
    public static void bakeModel(Map<ResourceLocation, BakedModel> map, String modId, String item, CustomItemOverrides itemOverrides) {
        ResourceLocation modelInventory = new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(modId, item), "inventory");
        ResourceLocation modelHand = new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(modId, item + "_in_hand"), "inventory");
