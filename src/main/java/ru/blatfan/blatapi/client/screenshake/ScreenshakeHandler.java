package ru.blatfan.blatapi.client.screenshake;
...
import ru.blatfan.blatapi.common.raycast.RayCast;
import ru.blatfan.blatapi.common.raycast.RayCastContext;
import ru.blatfan.blatapi.common.raycast.RayHitResult;
...
public class ScreenshakeHandler {
    ...
    public static void clientTick(Camera camera) {
        double intensity = BlatApiClientConfig.SCREENSHAKE_INTENSITY.get();
