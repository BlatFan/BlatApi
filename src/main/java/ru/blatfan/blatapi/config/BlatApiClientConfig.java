...
public class BlatApiClientConfig {
    public static ForgeConfigSpec.ConfigValue<Boolean> ITEM_PARTICLE, ITEM_GUI_PARTICLE, ITEM_IN_HAND_PARTICLE, BLOOD_PARTICLE, LIGHTNING_BOLT_EFFECT, EXPLOSION_EFFECT, MENU_BUTTON;
    public static ForgeConfigSpec.ConfigValue<Integer> MENU_BUTTON_ROW, MENU_BUTTON_ROW_X_OFFSET, MENU_BUTTON_X_OFFSET, MENU_BUTTON_Y_OFFSET;
    public static ForgeConfigSpec.ConfigValue<Double> SCREENSHAKE_INTENSITY;
    public static ForgeConfigSpec.ConfigValue<String> PANORAMA, CUSTOM_WINDOW_TITLE;

    public BlatApiClientConfig(ForgeConfigSpec.Builder builder) {
    ...
    public static final BlatApiClientConfig INSTANCE;
    public static final ForgeConfigSpec SPEC;

    static {
        final Pair<BlatApiClientConfig, ForgeConfigSpec> specPair = new ForgeConfigSpec.Builder().configure(BlatApiClientConfig::new);
